...
flags.DEFINE_string('weights', './data/yolov4-customv1_5000.weights', 'path to weights file')
flags.DEFINE_string('output', './models/yolov4.tflite', 'path to output')
...
def save_model(model):
    model.summary()
    model.save("models/yolov4_saved")
